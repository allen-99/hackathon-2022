...
const ModalFavCard = ({show, handleClose, item}) => {
    return (
                ...
                <div className={'pt-3 px-1 '}>
                    <div className={'flex'}>
                        <div className={'w-[173px]'}>
                            ...
                            <p className={'text-start text-grey-100 text-sm m-0'}>{item.author}</p>
                        ...
                        <div className={'grid justify-items-end w-full'}>
                            <img src={'./covers/small_book_cover.png'}
                    ...
                    <div className={'grid justify-items-center mt-4'}>
                        <div className={'px-3 py-1 rounded-xl bg-yellow w-max flex'}>
